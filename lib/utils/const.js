...
const obfuscationOptions = {
    ...
    reservedNames: [
        "defaultBuiltinList",
        // Google Analytics & Tag Manager 保护
        "gtag", "ga", "dataLayer", "GoogleAnalyticsObject", 
        "gaplugins", "gaGlobal", "_gaq", "_gat", "goog_report_conversion",
        // 其他第三方分析工具保护
        "fbq", "_fbq", "analytics", "mixpanel", "amplitude", 
        "_hmt", "yaCounter", "_paq"
    ], // [] 保留的标识符列表（不会被混淆）关键：用于保护公共API和第三方分析工具
